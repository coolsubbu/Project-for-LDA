...
print('reading csv')
dataframe= pd.read_csv(r'C:\Users\lenovo\Downloads\corpus _1.csv')
...
for i,v in dataframe.iterrows():
  ...
  if(re.search(r'(\w\.\w\.\w\.)',string)):
      ...
      """    
      if(re.search(r'[^usc]\.\s*',string)):

      str_match=re.search(r'([^usc])\.\s*',string)
      """
...
""" 
"""
  doc=nlp(" Apple is delicious ")
  doc1=nlp(" Orange is a fruit")
  print("similarity : " + str( doc1.similarity(doc) ))
  for token in doc:
